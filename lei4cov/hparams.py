...
class Hparams:
    ...
    # input
    parser.add_argument('--n_input', default=16, type=int)
    ...
    parser.add_argument('--save_model_path', default='./example/Lei4Cov/', help='save model path')
    parser.add_argument('--entity_embedding_path', default='./example/entity_embedding.pkl',
                        help='save entity_embedding path')
    parser.add_argument('--entity_encode_file', default='../data/entity_encode_file.txt',
                        help='entity_encode_file')
